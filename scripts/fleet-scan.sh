...
# FLEET.md. The engine behind wayfare:wayfare-review-fleet, which prints this
...
[ -f "$ROOT/FLEET.md" ] || { echo "fleet-scan: no FLEET.md in $ROOT; run wayfare:wayfare-sync-fleet to create one" >&2; exit 2; }
