...
Dry-run any pre-push hooks now so failures surface before the user runs `hero-skills:push`:
...
Ready to push with hero-skills:push
```
...
- **DO NOT PUSH** - Let user decide with `hero-skills:push`
