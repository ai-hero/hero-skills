...
announce `setup-dev: running recalibrate`, then follow the four phases in
...
```
hero-skills:setup-dev          # Full guided setup
hero-skills:setup-dev --check  # Just verify, don't change anything
```
