...
`ARCHITECTURE.md`'s `## Decisions` section (dated entry, append-only —
`hero-skills:architecture` owns the format) — the grilled Context /
Alternatives / Reversibility answers _are_ the entry; don't make the user
