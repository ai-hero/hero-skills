...
it against the HERO.md template in `wayfare-hero init`'s reference and against what the skills
...
- **Field coverage matters.** Every HERO.md field should be produced by `wayfare-hero init` and consumed by at least one skill.
