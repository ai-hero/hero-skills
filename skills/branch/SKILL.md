...
argument-hint: DESCRIPTION_OF_WORK
disable-model-invocation: true
---

# Branch — Create Feature Branch from Description
...
If `HERO.md` is missing, suggest `hero-skills:init` but proceed with `github-standard` convention.
...
Ready to work. When done:
  hero-skills:commit  - review and commit changes
